...
export default function AdminSidebar() {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      path: '/dashboard/admin/admins_view',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      path: '/dashboard/admin/farmers_view',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Nutrients',
      path: '/dashboard/admin/nutrients',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Soil Health Requests',
      path: '/dashboard/admin/soil-health-requests',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Rotation Rules',
      path: '/dashboard/admin/rotation-rules',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
